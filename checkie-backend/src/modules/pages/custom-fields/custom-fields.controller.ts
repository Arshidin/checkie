...
export class CustomFieldsController {
  ...
  async create(@Param('pageId') pageId: string, @Body() dto: CreateCustomFieldDto) {
  ...
  async bulkCreate(@Param('pageId') pageId: string, @Body() fields: CreateCustomFieldDto[]) {
  ...
  async findById(@Param('pageId') pageId: string, @Param('fieldId') fieldId: string) {
  ...
  async delete(@Param('pageId') pageId: string, @Param('fieldId') fieldId: string) {
  ...
  async reorder(@Param('pageId') pageId: string, @Body('fieldIds') fieldIds: string[]) {
